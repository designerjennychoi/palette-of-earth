...
- ImageBlend: 두 이미지 레이어 블렌드 애니메이션 (`components/media/ImageBlend.jsx`)
- GlobeD3: d3-geo 정사영 SVG 지구본(흑백). 자동 회전 · 드래그 회전 · 마커 hover 색상 칩 + onHoverCountry 콜백, prefers-reduced-motion 대응 (`components/media/GlobeD3.jsx`)
